...
const resources = {
  ar: {
    translation: {
      ...
      pleaseUploadCRDocument: "يرجى رفع وثيقة السجل التجاري",
      pleaseSelectLocation: "يرجى اختيار موقعك",
      pleaseSelectJobLocation: "يرجى اختيار الموقع",
      pleaseEnterRejectionReason: "يرجى إدخال سبب الرفض",
      registrationSuccessful: "تم التسجيل بنجاح!",
      registrationSuccessfulAwaiting: "تم التسجيل بنجاح! في انتظار موافقة الإدارة.",
      loginSuccessful: "تم تسجيل الدخول بنجاح!",
      fileUploadedSuccessfully: "تم رفع الملف بنجاح",
      applicationSubmittedSuccess: "تم تقديم طلبك بنجاح باستخدام السيرة الذاتية المحفوظة",
  ...
  en: {
    translation: {
      ...
      pleaseUploadCRDocument: "Please upload CR document",
      pleaseSelectLocation: "Please select your location",
      pleaseSelectJobLocation: "Please select location",
      pleaseEnterRejectionReason: "Please enter rejection reason",
      registrationSuccessful: "Registration successful!",
      registrationSuccessfulAwaiting: "Registration successful! Awaiting admin approval.",
      loginSuccessful: "Login successful!",
      fileUploadedSuccessfully: "File uploaded successfully",
      applicationSubmittedSuccess: "Your application has been submitted successfully using your saved CV",
