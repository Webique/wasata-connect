...
import { Building2, Phone, Mail, Lock, ArrowRight, ArrowLeft } from 'lucide-react';
          ...
          <Card className="border-2 shadow-2xl">
            <CardHeader className="flex flex-col gap-6 pb-8">
              ...
              <div className="text-center flex flex-col gap-2">
                <CardTitle className="text-3xl">{t('loginAsCompany')}</CardTitle>
                <CardDescription className="text-base">{t('loginAsCompanyDesc')}</CardDescription>
              </div>
            </CardHeader>
            <CardContent>
